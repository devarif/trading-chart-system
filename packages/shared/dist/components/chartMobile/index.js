...
const ChartMobile = (props) => {
    ...
    const renderChart = (0, react_1.useMemo)(() => (React.createElement(react_native_1.SafeAreaView, { style: { flex: 1 } },
        React.createElement(react_native_webview_1.default, { style: { flex: 1 }, source: {
            ...
            allowUniversalAccessFromFileURLs: true, originWhitelist: ['*'], onShouldStartLoadWithRequest: () => true }))), [iframeSrc, refIframe]);
    return renderChart;
};
exports.ChartMobile = ChartMobile;
